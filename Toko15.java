...
public class Toko15 {
    public static void main(String[] args) {
        ...
        int qty, jumlah = 0;
        double diskon, disBarang, bayar; 
        double jmlDiskon = 0, totalDiskon = 0, harga = 0, total = 0, disMember = 0;
        char tambah, member;
